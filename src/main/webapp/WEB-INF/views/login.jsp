...
<body style="background-color: #F3F3F3">
    <div class="easyui-dialog" title="管理员登录" data-options="closable:false,draggable:false" style="width:400px;height:300px;padding:10px;">
       	<div style="margin-left: 50px;margin-top: 50px;">
       		<form id="from" action="${pageContext.request.contextPath }/console/login" method="post">
	        ...
	        <div>
	            <input  class="easyui-linkbutton" type="submit" style="width:100px;height:32px;margin-left: 50px" data-options="" value="登录"/>
